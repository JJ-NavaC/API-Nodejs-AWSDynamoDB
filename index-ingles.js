    ...
    switch (event.routeKey) {
      case "GET /posts":
        if (!event.queryStringParameters) {
          ...
          else if (event.queryStringParameters.departament) {
            params = {
              TableName: comunicatecmm,
              FilterExpression: "departament = :departament",
              KeyConditionExpression: "departament = :departament",
              ExpressionAttributeValues: {
                ":departament": event.queryStringParameters.departament,
              },
            };
            body = await dynamo
              .scan(params)
        ...
        await dynamo
          .put({
            ...
            Item: {
              ...
              departament: requestJSON.departament,
